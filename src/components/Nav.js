...
function Nav() {
    ...
    return (
        <nav className="w-2/24 lg:w-21/24">
            ...
            {/* Mobile nav */}
            <div className={navOpen ? "bg-107-neutral h-screen w-screen fixed inset-0 z-10" : "hidden"}>
                <div className="wrapper">
                    <div className="flex justify-between">
                        ...
                        <button onClick={toggleNav} className="mb-4" aria-label="Close menu">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 20 20" fill="#000">
                                <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                            </svg>
                        </button>
                    </div>
                    <ul className="text-xl">
                        <li className="mb-3"><a href="https://107.org.au/the-big-idea/">About</a></li>
                        <li className="mb-3"><a href="https://107.org.au/whats-on/">What's On</a></li>
                        <li className="mb-3"><a href="https://107.org.au/space-hire/">Space Hire</a></li>
                        <li className="mb-3"><a href="https://107.org.au/blog/">Blog</a></li>
                        <li className="mb-3"><a href="https://107.org.au/volunteer-program/">Volunteer</a></li>
                        <li className="mb-3"><a href="https://107.org.au/donate/">Donate</a></li>
                        <li className="mb-3"><a href="https://107.org.au/subscribe/">Subscribe</a></li>
                        <li className="mb-3"><a href="https://107.org.au/contact/">Contact & FAQs</a></li>
                    </ul>
                </div>
            </div>
            {/* End mobile nav */}
