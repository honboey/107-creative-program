...
function SpecialEvents() {
    ...
    return (
        <section className={open === false ? "h-12 md:h-24 lg:h-28 overflow-hidden" : null}>
            <button
                onClick={toggleOpen}
                className="bg-107-reva-green-100 hover:bg-107-reva-green-200 w-full text-left">
                <div className="wrapper">
                    <h2 className="text-5xl md:text-8xl font-medium pb-4 md:pb-8 lg:pb-12">Special Events</h2>
